...
$(function() {
    ...
    var content = '';
    var qq = [{"catid":1,"title":"QQ Consulting","value":"120385306"}];
    var wangwang = [];
    var other = [];
